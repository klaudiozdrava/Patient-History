<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditVisit.aspx.cs" Inherits="Patient_History.EditVisit" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Επεξεργασία Επίσκεψης</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="form-group row">
                <asp:Label ID="datelabel" runat="server" class="col col-form-label"></asp:Label>
            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <asp:DropDownList ID="DropDownList1" runat="server" class="form-control">
                            <asp:ListItem Value="pending">Εκκρεμεί</asp:ListItem>
            ...
            <div class="form-group row">
                <div class="col">
                    <asp:Button runat="server" Text="Επεξεργασία" OnClick="Button1_Click" class="btn btn-primary"/>
